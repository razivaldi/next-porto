...
const ProjectCard = ({
  ...
  return (
    <div>
      ...
      >
        <div className="overlay gap-3 rounded-t-lg items-center justify-center absolute top-0 left-0 right-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
          <Link
